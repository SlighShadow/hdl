...
assign {mxfe0_gpio5_t,
        mxfe1_gpio5_t,
        mxfe2_gpio5_t,
        mxfe3_gpio5_t} = {4{gpio_t[67]}};

assign {mxfe0_gpio6_t,
        mxfe1_gpio6_t,
        mxfe2_gpio6_t,
        mxfe3_gpio6_t} = {4{gpio_t[68]}};

assign {mxfe0_gpio7_t,
        mxfe1_gpio7_t,
        mxfe2_gpio7_t,
        mxfe3_gpio7_t} = {4{gpio_t[69]}};

assign {mxfe0_gpio8_t,
        mxfe1_gpio8_t,
        mxfe2_gpio8_t,
        mxfe3_gpio8_t} = {4{gpio_t[70]}};

assign {mxfe0_gpio9_t,
        mxfe1_gpio9_t,
        mxfe2_gpio9_t,
        mxfe3_gpio9_t} = {4{gpio_t[71]}};

assign {mxfe0_gpio10_t,
        mxfe1_gpio10_t,
        mxfe2_gpio10_t,
        mxfe3_gpio10_t} = {4{gpio_t[72]}};

assign {mxfe0_syncin_1_n_t,
        mxfe1_syncin_1_n_t,
        mxfe2_syncin_1_n_t,
        mxfe3_syncin_1_n_t} = {4{gpio_t[73]}};

assign {mxfe0_syncin_1_p_t,
        mxfe1_syncin_1_p_t,
        mxfe2_syncin_1_p_t,
        mxfe3_syncin_1_p_t} = {4{gpio_t[74]}};

assign {mxfe0_syncout_1_n_t,
        mxfe1_syncout_1_n_t,
        mxfe2_syncout_1_n_t,
        mxfe3_syncout_1_n_t} = {4{gpio_t[75]}};

assign {mxfe0_syncout_1_p_t,
        mxfe1_syncout_1_p_t,
        mxfe2_syncout_1_p_t,
        mxfe3_syncout_1_p_t} = {4{gpio_t[76]}};
...
assign {mxfe0_gpio5_o,
        mxfe1_gpio5_o,
        mxfe2_gpio5_o,
        mxfe3_gpio5_o} = {4{gpio_o[67]}};

assign {mxfe0_gpio6_o,
        mxfe1_gpio6_o,
        mxfe2_gpio6_o,
        mxfe3_gpio6_o} = {4{gpio_o[68]}};

assign {mxfe0_gpio7_o,
        mxfe1_gpio7_o,
        mxfe2_gpio7_o,
        mxfe3_gpio7_o} = {4{gpio_o[69]}};

assign {mxfe0_gpio8_o,
        mxfe1_gpio8_o,
        mxfe2_gpio8_o,
        mxfe3_gpio8_o} = {4{gpio_o[70]}};

assign {mxfe0_gpio9_o,
        mxfe1_gpio9_o,
        mxfe2_gpio9_o,
        mxfe3_gpio9_o} = {4{gpio_o[71]}};

assign {mxfe0_gpio10_o,
        mxfe1_gpio10_o,
        mxfe2_gpio10_o,
        mxfe3_gpio10_o} = {4{gpio_o[72]}};

assign {mxfe0_syncin_1_n_o,
        mxfe1_syncin_1_n_o,
        mxfe2_syncin_1_n_o,
        mxfe3_syncin_1_n_o} = {4{gpio_o[73]}};

assign {mxfe0_syncin_1_p_o,
        mxfe1_syncin_1_p_o,
        mxfe2_syncin_1_p_o,
        mxfe3_syncin_1_p_o} = {4{gpio_o[74]}};

assign {mxfe0_syncout_1_n_o,
        mxfe1_syncout_1_n_o,
        mxfe2_syncout_1_n_o,
        mxfe3_syncout_1_n_o} = {4{gpio_o[75]}};

assign {mxfe0_syncout_1_p_o,
        mxfe1_syncout_1_p_o,
        mxfe2_syncout_1_p_o,
        mxfe3_syncout_1_p_o} = {4{gpio_o[76]}};
...
assign gpio_i[67] = |{mxfe0_gpio5_i,
                      mxfe1_gpio5_i,
                      mxfe2_gpio5_i,
                      mxfe3_gpio5_i};

assign gpio_i[68] = |{mxfe0_gpio6_i,
                      mxfe1_gpio6_i,
                      mxfe2_gpio6_i,
                      mxfe3_gpio6_i};

assign gpio_i[69] = |{mxfe0_gpio7_i,
                      mxfe1_gpio7_i,
                      mxfe2_gpio7_i,
                      mxfe3_gpio7_i};

assign gpio_i[70] = |{mxfe0_gpio8_i,
                      mxfe1_gpio8_i,
                      mxfe2_gpio8_i,
                      mxfe3_gpio8_i};

assign gpio_i[71] = |{mxfe0_gpio9_i,
                      mxfe1_gpio9_i,
                      mxfe2_gpio9_i,
                      mxfe3_gpio9_i};

assign gpio_i[72] = |{mxfe0_gpio10_i,
                      mxfe1_gpio10_i,
                      mxfe2_gpio10_i,
                      mxfe3_gpio10_i};

assign gpio_i[73] = |{mxfe0_syncin_1_n_i,
                      mxfe1_syncin_1_n_i,
                      mxfe2_syncin_1_n_i,
                      mxfe3_syncin_1_n_i};

assign gpio_i[74] = |{mxfe0_syncin_1_p_i,
                      mxfe1_syncin_1_p_i,
                      mxfe2_syncin_1_p_i,
                      mxfe3_syncin_1_p_i};

assign gpio_i[75] = |{mxfe0_syncout_1_n_i,
                      mxfe1_syncout_1_n_i,
                      mxfe2_syncout_1_n_i,
                      mxfe3_syncout_1_n_i};

assign gpio_i[76] = |{mxfe0_syncout_1_p_i,
                      mxfe1_syncout_1_p_i,
                      mxfe2_syncout_1_p_i,
                      mxfe3_syncout_1_p_i};

  //loopback unused gpios
  assign gpio_i[107:77] = gpio_o[107:77];
