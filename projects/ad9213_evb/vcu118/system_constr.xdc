...
# set_property  -dict {PACKAGE_PIN AL35 IOSTANDARD LVDS} [get_ports  glbl_clk_1_p]                              ; ##   LA00_P_CC      IO_L7P_T1L_N0_QBC_AD13P_43
# set_property  -dict {PACKAGE_PIN AL36 IOSTANDARD LVDS} [get_ports  glbl_clk_1_n]                              ; ##   LA00_N_CC      IO_L7N_T1L_N1_QBC_AD13N_43
...
set_property  -dict {PACKAGE_PIN AT35 IOSTANDARD LVCMOS18} [get_ports spi0_sdio]                              ; ##   LA06_P         IO_L2P_T0L_N2_43
set_property  -dict {PACKAGE_PIN AT36 IOSTANDARD LVCMOS18} [get_ports spi0_sclk]                              ; ##   LA06_N         IO_L2N_T0L_N3_43
set_property  -dict {PACKAGE_PIN AP36 IOSTANDARD LVCMOS18} [get_ports spi0_csb]                               ; ##   LA07_P         IO_L5P_T0U_N8_AD14P_43
set_property  -dict {PACKAGE_PIN AG32 IOSTANDARD LVCMOS18} [get_ports spi1_sdi]                               ; ##   LA15_P         IO_L24P_T3U_N10_43
set_property  -dict {PACKAGE_PIN AG31 IOSTANDARD LVCMOS18} [get_ports spi1_csb]                               ; ##   LA14_P         IO_L23P_T3U_N8_43
set_property  -dict {PACKAGE_PIN AH31 IOSTANDARD LVCMOS18} [get_ports spi1_sclk]                              ; ##   LA14_N         IO_L23N_T3U_N9_43
set_property  -dict {PACKAGE_PIN AG34 IOSTANDARD LVCMOS18} [get_ports spi2_sclk]                              ; ##   LA16_P         IO_L22P_T3U_N6_DBC_AD0P_43
set_property  -dict {PACKAGE_PIN AH35 IOSTANDARD LVCMOS18} [get_ports spi2_sdio]                              ; ##   LA16_N         IO_L22N_T3U_N7_DBC_AD0N_43
set_property  -dict {PACKAGE_PIN N33  IOSTANDARD LVCMOS18} [get_ports spi2_csb]                               ; ##   LA19_P         IO_L22P_T3U_N6_DBC_AD0P_45
